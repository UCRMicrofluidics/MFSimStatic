...
1.) Get source from repository:
	...
	- Create a folder for your projects, and then inside, create a folder called "MFSimStatic"
	- Right click on the folder and select "SVN Checkout..."
	- Enter the address of the repository: "https://svn1.cs.ucr.edu/grissomd/MFSimStatic" and check out using your CS username/password
